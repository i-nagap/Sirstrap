        ...
        private static IReadOnlyList<SettingDefinition> BuildSettings(SirstrapConfiguration configuration, ICdnUriNormalizer cdnUriNormalizer, IPerformanceTelemetry performanceTelemetry)
        {
            ...
            [
                ...
                Setting.String("ROBLOX_VERSION_OVERRIDE",
                    ...
                    Metric("RobloxVersionOverride", () => string.IsNullOrEmpty(configuration.RobloxVersionOverride) ? "Auto" : "Custom"),
                    valueMigrator: value => value.Trim()),
                ...
                Setting.String("SIRSTRAP_LANGUAGE",
                    () => configuration.SirstrapLanguage,
                    value => configuration.SirstrapLanguage = value,
                    Metric("SirstrapLanguage", () => string.IsNullOrEmpty(configuration.SirstrapLanguage) ? "System" : configuration.SirstrapLanguage)),
